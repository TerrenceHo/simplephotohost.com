...
// Bytes will help generate n random bytes, or returns an error if there was
// one., This uses the crypto/rand package so it is safe to generate tokens
